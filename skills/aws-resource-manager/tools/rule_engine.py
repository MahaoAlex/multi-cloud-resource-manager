#!/usr/bin/env python3
"""
Rule Engine for AWS Resource Manager
...
def main():
    ...
    # Test evaluation
    test_resources = [
        {'id': 'i-001', 'name': 'web-server', 'cpu_avg_24h': '5.2%'},
        {'id': 'i-002', 'name': 'user-00123456-app', 'cpu_avg_24h': '25%'}
    ]

    print("\nTest Evaluation Results:")
    violations = engine.evaluate_resources(test_resources, 'ec2')
    for v in violations:
